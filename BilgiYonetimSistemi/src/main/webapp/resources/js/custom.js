(function () {
  ...
  function toggleTheme() {
    ...
    if (html.getAttribute("data-theme-mode") === "dark") {
      PrimeFaces.changeTheme("saga-blue");
      ...
      PrimeFaces.changeTheme('luna-blue')
      html.setAttribute("data-theme-mode", "dark");
      html.setAttribute("data-header-styles", "dark");
      if (!localStorage.getItem("primaryRGB")) {
        html.setAttribute("style", "");
  ...
  var activeUser = document.getElementById("active-users");
  if(activeUser){
...
/* for active-users dropdown */
// const headerbtn11 = document.querySelectorAll(".dropdown-item-close1");
// headerbtn11.forEach((button) => {
//   button.addEventListener("click", (e) => {
//     e.preventDefault();
//     e.stopPropagation();
//     button.parentNode.parentNode.parentNode.parentNode.remove();
//     document.getElementById("users-data").innerText = `${document.querySelectorAll(".dropdown-item-close1").length
//     }`;
//     if (document.querySelectorAll(".dropdown-item-close1").length == 0) {
//       let elementHide1 = document.querySelector(".empty-header-item");
//       elementHide1.classList.add("d-none");
//     }
//   });
// });
