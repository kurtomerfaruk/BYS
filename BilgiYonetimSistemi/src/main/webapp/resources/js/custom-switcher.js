...
function ltrFn() {
    ...
    if (!document.querySelector("#style").href.includes('bootstrap.min.css')) {
        document.querySelector("#style")?.setAttribute("href", "https://codeigniter.spruko.com/zynix/zynix/assets/libs/bootstrap/css/bootstrap.min.css");
    }
...
function rtlFn() {
    ...
    document.querySelector("#style")?.setAttribute("href", "https://codeigniter.spruko.com/zynix/zynix/assets/libs/bootstrap/css/bootstrap.rtl.min.css");
    checkOptions();
}
