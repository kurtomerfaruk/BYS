...
document.querySelectorAll('.sublevel2').forEach(element => {
  ...
  element.addEventListener('click', function () {
    ...
    let sublevel1 = element.closest('ul.child2').previousElementSibling;
    if (sublevel1 && sublevel1.classList.contains('sublevel1')) {
      sublevel1.classList.add('active');
    }

    let mainMenu = element.closest('ul.child1').previousElementSibling;
    if (mainMenu && mainMenu.classList.contains('main_menu')) {
