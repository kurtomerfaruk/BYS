...
@ViewScoped
@Slf4j
public class OrtBasvuruSecMalzemeTalepController extends AbstractController<OrtBasvuru> {

    @Serial
    private static final long serialVersionUID = 7705744810106122752L;

    public OrtBasvuruSecMalzemeTalepController() {
    ...
    public void init(){
        this.getFilterMap().put("basvuruDurumu", FilterMeta
                ...
                .build());
        this.getFilterMap().put("sutKodu", FilterMeta
                .builder()
                .field("sutKodu")
