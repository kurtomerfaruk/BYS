...
@Setter
@Entity
@Table(name = "MEPERSONEL")
public class MePersonel extends BaseEntity {
    @Serial
    private static final long serialVersionUID = 5610721880469479860L;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof MePersonel other)) {
            return false;
        }
