...
@ResourceDependency(library = Constants.LIBRARY, name = "leaflet.css", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "leaflet.js", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "loading/loading.css", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "loading/loading.js", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "Leaflet.fullscreen.css", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "Leaflet.fullscreen.min.js", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "heatmap/leaflet-heat.js", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "routemachine/leaflet-routing-machine.css", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "routemachine/leaflet-routing-machine.js", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "routemachine/Control.Geocoder.js", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "routemachine/config.js", target = "head")
@ResourceDependency(library = Constants.LIBRARY, name = "leafmap.js", target = "head")
